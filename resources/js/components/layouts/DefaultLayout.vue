...
import inoveLogo from '../../../img/inove-logo.png';
...
<template>
  <div class="relative min-h-screen">
    ...
    <div class="bg-base-300 text-base-content py-4 px-4 text-light-grey flex justify-between items-center fixed left-0 right-0 z-20">

      <span class="mdi mdi-menu text-3xl cursor-pointer md:hidden" @click="toggleSidebar"></span>

      <div class="cursor-pointer">
        <router-link :to="{ name: 'Home' }">
          <div class="flex space-x-3 items-center">
            <img :src="inoveLogo" class="w-8 h-8" alt="Inove logo"/>
            <span class="text-3xl font-light pl-4">Laravel Vue Boilerplate</span>
          </div>
        </router-link>
      </div>
